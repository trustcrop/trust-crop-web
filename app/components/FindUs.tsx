...
const socialLinks: SocialLink[] = [
    {
        label: 'Linktree',
        href: 'https://linktr.ee/trustcrop',
        icon: <LinktreeIcon/>,
    },
    {
        label: 'LinkedIn',
        href: 'https://www.linkedin.com/company/trustcrop/',
        icon: <LinkedInIcon/>,
    },
    {
        label: 'Facebook',
        href: 'https://www.facebook.com/people/TrustCrop/61590928021585/',
        icon: <FacebookIcon/>,
    },
    {
        label: 'Instagram',
        href: 'https://www.instagram.com/trustcrop.gr',
        icon: <InstagramIcon/>,
    },
    {
        label: 'TikTok',
        href: 'https://www.tiktok.com/@trustcrop.gr',
        icon: <TikTokIcon/>,
    },
    {
        label: 'X',
        href: 'https://x.com/TrustCrop',
        icon: <XIcon/>,
    },
    {
        label: 'GitHub',
        href: 'https://github.com/trustcrop',
        icon: <GitHubIcon/>,
    },
]
        ...
        <Section id="find-us">
            <Stack direction="vertical" gap={48} alignItems="center">
                <Stack direction="vertical" gap={8} alignItems="center">
                    ...
                    <Text as="p" size="200" variant="muted" style={{textAlign: 'center', maxWidth: 480}}>
                        Ακολουθήστε μας στα social media και μείνετε ενήμεροι για τα νέα του TrustCrop.
                    </Text>
                </Stack>
